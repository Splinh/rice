...
import {
  createCollection,
  useCallbackRef
} from "./chunk-2AAXZ3KG.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState,
  useLayoutEffect2
} from "./chunk-DJ4Q22NZ.js";
import {
  require_react_dom
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime13.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime13.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime13.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime13.jsx)(Collection.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime13.jsx)(Primitive3.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime13.jsx)(
            FocusProxy,
            {
...
var Toast = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime13.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime13.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime13.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime13.jsx)(Collection.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime13.jsx)(
          Root,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime13.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime13.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Primitive3.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Primitive3.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime13.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime13.jsx)(
      Primitive3.button,
      {
        type: "button",
        ...closeProps,
